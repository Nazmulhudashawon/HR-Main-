...
(function($, window, document, undefined) {
	...
	$.fn.imageuploadify = function(opts) {
		...
		this.each(function() {
			...
			let totalFiles = [];
			let counter = 0;
			let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></div><div class="imageuploadify-images-list text-center"><i class="bx bxs-cloud-upload"><span class='imageuploadify-message'>Drag&Drop Your File(s)Here To Upload</span><button type="button"class="btn btn-default">or select file to upload</button></div></div>`);
			...
			const readingFile = (id, file) => {
				...
				if (file.type && file.type.search(/image/) != -1) {
					...
					let type = "<i class='fa fa-file'>";
					if (file.type.search(/audio/) != -1) {
						type = "<i class='fa fa-file-audio-o'>";
					} else if (file.type.search(/video/) != -1) {
						type = "<i class='fa fa-file-video-o'>";
					}
					fReader.onloadend = function(e) {
